##############################################################
####  Generate table of results. Level2_Interaction ####
##############################################################
...
load("Results_Level2_Interaction.RData")
...
load("Results_Level2_Interaction_sens2.RData")
...
load("Results_Level2_Interaction_sens5.RData")
...
write.table(Table.of.results, "Table_f.txt", sep=",")