##############################################################
####  Generate table of results. Level 2 imputation       ####
##############################################################
...
load("Results_Level2_sens2.RData")
...
load("Results_Level2_sens5.RData")
...
write.table(Table.of.results, "Table_e.txt", sep=",")