##############################################
####  Random slope. Sensit to variance 2  ####
##############################################
...
# Sensitivity to larger variance of random slope
sensitivity.par<-2
reff.smc[2,2]<-sensitivity.par*reff.smc[2,2]
reff.smc[1,2]<-sqrt(sensitivity.par)*reff.smc[1,2]
reff.smc[2,1]<-sqrt(sensitivity.par)*reff.smc[2,1]
...
# save.image( file="Results_Base_case_sensitivity_2.RData")
