##############################################################
####  Generate table of results. Sensitivity              ####
##############################################################
...
##############################################
#### Load results sensitivity 1           ####

load("Results_Sensitivity1.RData")
...
load("Results_Sensitivity2.RData")
...
write.table(Table.of.results, "Table_m.txt", sep=",")