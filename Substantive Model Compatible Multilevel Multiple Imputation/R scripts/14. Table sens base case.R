...
load("//ad.ucl.ac.uk/homeu/rmjlmqu/Documents/Missing data/SMC-jomo/Tutorial+Simulations paper/R script + Data/Results_Base_case_sensitivity_2.RData")
...
load("//ad.ucl.ac.uk/homeu/rmjlmqu/Documents/Missing data/SMC-jomo/Tutorial+Simulations paper/R script + Data/Results_Base_case_sensitivity_5.RData")
...
write.table(Table.of.results, "Table_a.txt", sep=",")