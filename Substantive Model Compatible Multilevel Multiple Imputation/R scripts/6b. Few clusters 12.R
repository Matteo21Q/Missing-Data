...
for (i in 1:n.sim) {
  ...
  X<-data.frame(1, as.numeric(Xvar[,1]<0), Xvar[,2])
  Z<-data.frame(1, as.numeric(Xvar[,1]<0))
...
# save.image( file="Results_fewclusters12.RData")
