...
load("//ad.ucl.ac.uk/homeu/rmjlmqu/Documents/Missing data/SMC-jomo/Tutorial+Simulations paper/R script + Data/Results_Random_Intercept.RData")
...
#Convert random intercept Var in SD:
rev.FD<-sqrt(rev.FD)
rev.CR<-sqrt(rev.CR)
...
##############################################
#### Load results random slope model      ####

load("//ad.ucl.ac.uk/homeu/rmjlmqu/Documents/Missing data/SMC-jomo/Tutorial+Simulations paper/R script + Data/Results_Base_case.RData")
...
write.table(Table.of.results, "Table2.txt", sep=",")